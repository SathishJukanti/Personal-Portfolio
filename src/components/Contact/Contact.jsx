      ...
      className='min-h-screen w-full flex justify-center items-center'>
        ...
        className='md:min-h-[300px] md:w-[400px] h-[500px] w-[300px]'>
          ...
          className='flex flex-col '>  
            <div 
            className='md:h-[40px] md:w-[170px] flex border-b border-white md:ml-28'>
              <h1 
              className='ml-16 md:ml-0 text-white text-3xl font-bold font-serif grid tracking-[.08em]'>CONTACT</h1>
            </div>
            <div>
              <p 
