        ...
        >
          ...
          <div 
            className='w-[300px] h-[300px] md:w-[400px] md:mt-4 mt-8'>
              ...
              <h3 
              className='text-md text-center font-serif text-slate-300 md:ml-8 m-4 text-balance'>React Router simplifies client-side routing by updating the URL and rendering components without full page reloads.</h3>
              <div 
          ...
          className='w-[300px] h-[300px] md:w-[400px] md:mt-4 mt-8'>
            ...
            <h3 
            className='text-md text-center font-serif text-slate-300 md:ml-8 m-4'>My Blog Post project is a web application that allows users to read and publish blog articles.
            </h3>       
            <div 
            className='flex md:flex-wrap gap-8 text-white md:px-16 md:py-6 mt-4 ml-6'>
              <Link
          ...
          className='w-[300px] h-[300px] md:w-[400px] md:mt-4 mt-8'>
            ...
            <h3 
            className='text-md text-center font-serif text-slate-300 md:ml-8 m-4'>A currency converter is a website that provides for the easy conversion of currency values based on present-day exchange rates.</h3>
            <div 
            className='flex md:flex-wrap gap-8 text-white md:px-16 md:py-6 mt-4 ml-6'>
              <Link
